...
class Human36mDataset(MocapDataset):
    def __init__(self, poses_3d, remove_static_joints=True):
        ...
        for cameras in self._cameras.values():
            for i, cam in enumerate(cameras):
                ...
                cam['center'] = normalize_screen_coordinates(cam['center'], w=cam['res_w'], h=cam['res_h'], pt=False).astype('float32')
